...
#[pyfunction]
pub fn get_imports_from_py_files(
    py: Python,
    ...
    let results: Vec<_> = file_paths
        .par_iter()
        .map(|path_str| {
            let result = get_imports_from_py_file(path_str, typing_alias.clone());
            shared::ThreadResult {
